...
const orderHSlice = createSlice({
  name: "order",
  initialState,
  reducers: {
    setAllOrderHData: (state, action) => {
...
export const { setOrderData, filterProductsByAlphabetic, setAllOrderHData } =
  orderHSlice.actions;

export default orderHSlice.reducer;
